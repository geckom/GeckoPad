...
/* Next comes the mode change codes */
  ...
  MODE_INPUT,           // Number/symbols mode
  MODE_OTHER,           // Other keys mode
  MODE_NUM,             // Number mode
  MODE_NUMLCK,          // Number lock
  MODE_SYM,             // Symbols mode
  MODE_SYMLCK,          // Symbols lock
...
/* And finally macros, that generate multiple key presses */
  ...
  MACRO_exclamation,    // aka, FORCE_LSHIFT|KEY_1
  MACRO_atsign,         // aka, FORCE_LSHIFT|KEY_2
  MACRO_gt,             // aka, FORCE_LSHIFT|ENUMKEY_dot
  MACRO_lt,             // aka, FORCE_LSHIFT|ENUMKEY_comma
  MACRO_colon,          // aka, FORCE_LSHIFT|ENUMKEY_smcol
  MACRO_pipe,           // aka, FORCE_LSHIFT|ENUMKEY_bckslsh
  MACRO_tilde,          // aka, FORCE_LSHIFT|ENUMKEY_grave
  MACRO_caret,          // aka, FORCE_LSHIFT|KEY_6
  MACRO_hash,           // aka, FORCE_LSHIFT|KEY_3
  MACRO_underscore,     // aka, FORCE_LSHIFT|ENUMKEY_minus
